...
#je n'ai pas mis toutes les pages ici il en existe 72
nbr_pages = 6
...
def get_all_pages():
  ...
  for i in range(nbr_pages):
        i=f"https://avocatalgerien.com/listings/page/{page_number}/"
        page_number+=1
        urls.append(i)
...
def parse_avocats(url):
    ...
    avocats = soup.find_all('article', id )
    #print(len(avocats))
...
#j'appelle la fonction qui récup le tout 
parse_all_avocats()
